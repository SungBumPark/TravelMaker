...
public class MyCalendarActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		addEvent = (ImageView) this.findViewById(R.id.addEvent);
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.addEvent) {
			Intent i = new Intent(this, com.example.travelmaker.calendar.MainActivity.class);
			startActivity(i);
		}
